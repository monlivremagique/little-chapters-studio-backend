...
final class BookBriefPromptBuilder
{
    public function build(array $brief): array
    {
        ...
        $prompt = implode("\n", array_filter([
            ...
            '',
            '=== GENDER NEUTRALITY (HARD RULES — DO NOT VIOLATE) ===',
            '- FR: NEVER use il/elle/lui/soi/son/sa/ses for the child hero. Use {child_name}, {child_pronoun_subject}, or "l\'enfant".',
            '- EN: NEVER use he/she/him/her/his. Use {child_name}, {child_pronoun_subject}, {child_possessive_det}, or "the child".',
            '- NL: NEVER use hij/hem/zijn/haar for the child hero. Use {child_name}, {child_pronoun_subject}, {child_possessive_det}.',
            '- These are FORBIDDEN WORDS for the child character. Their use will cause QA REJECTION.',
            '- Write EVERY sentence so it works for any gender without changing a single word.',
            '',
            '=== EN LANGUAGE ===',
