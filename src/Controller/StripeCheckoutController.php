...
final class StripeCheckoutController
{
    public function __construct(
        ...
        #[Autowire(service: 'sylius.command_bus')]
        private readonly MessageBusInterface $messageBus,
    ) {
    }

    #[RateLimit('checkout', 'token')]
    #[Route(
    ...
    public function createCheckoutSession(Request $request): JsonResponse
    {
        ...
        $this->stripeCheckoutSynchronizer->replayPendingForProviderSessionId($checkoutSession->getProviderSessionId());

        return new JsonResponse($this->normalizeCheckoutSession($checkoutSession));
    }

    #[RateLimit('read', 'token')]
    #[Route(
    ...
    public function handleWebhook(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $this->messageBus->dispatch(new ProcessStripeWebhookMessage($event));
        } catch (\Throwable $exception) {
