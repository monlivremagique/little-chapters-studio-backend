...
SQL,
    ...
    private function normalizeOrder(array $orderRow, array $sessions): array
    {
        ...
        $fulfillment = $this->entityManager->getRepository(FulfillmentOrder::class)->findOneBy(['session' => $primarySession], ['id' => 'DESC']);
        /** @var PdfArtifact|null $pdf */
        $pdf = $this->entityManager->getRepository(PdfArtifact::class)->findOneBy(['session' => $primarySession], ['id' => 'DESC']);
    ...
    {
        $steps = [
            ['id' => 'confirmed', 'label' => 'Commande confirmee', 'description' => 'Le paiement a ete confirme.', 'status' => 'completed'],
            ['id' => 'pdf', 'label' => 'PDF final', 'description' => 'Le livre final est prepare pour impression.', 'status' => 'upcoming'],
            ['id' => 'production', 'label' => 'Production', 'description' => 'La commande est transmise a Gelato.', 'status' => 'upcoming'],
            ['id' => 'shipping', 'label' => 'Expedition', 'description' => 'Le colis est en transit.', 'status' => 'upcoming'],
            ['id' => 'delivery', 'label' => 'Livraison', 'description' => 'La commande a ete livree.', 'status' => 'upcoming'],
        ];
